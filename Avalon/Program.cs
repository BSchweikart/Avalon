...
// Need to split this up at some point and call it
namespace Avalon
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("");
                string selectedMenuItem = Console.ReadLine(); // Display the menu in the order listed
                ...
                string lowerInput = selectedMenuItem.ToLower();
